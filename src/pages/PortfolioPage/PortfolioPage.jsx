...
export default function PortfolioPage() {
    ...
    const descriptionList = [
        'I developed the website for Shes Not Here using typescript and NextJS. Shes Not Here is an all-female nonprofit rideshare service in the Chapel Hill area. The website educates interested parties on their serivce and allows potential drivers to apply. The website also helped get the accompanying app gain approval for release on the app store.',
        ...
        <div className="text-zone">
            <div className="portfolio-container">
                ...
                <div className='gallery-container'>
                    ...
                    >
                        <SwiperSlide key={0}>
                            <img src=".\photos\ShesNotHere.png" alt="photo" />
                            <div className='caption'>
                                <a href="https://www.shesnothere.org/" target='_blank'>Shes Not Here</a>
                            </div>
                        </SwiperSlide>
                        <SwiperSlide>
