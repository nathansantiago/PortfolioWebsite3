...
export function LinkedInIcon() {
    return (
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" strokeWidth={1.5} stroke="currentColor" fill="currentColor" className='size-6'>
...
export function GithubIcon() {
    return (
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 496 512" strokeWidth={1.5} stroke="currentColor" fill="currentColor" className='size-6'>
